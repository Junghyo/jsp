...
<%
	request.setAttribute("prod1", new Products());
	request.setAttribute("prod2", new Products());
%>	
<body>
	...
	<form method="post">
		<table align="center">
			<tr><th>물건명</th><th>가격</th><th>주문수량</th><th>계</th></tr>
			<tr><td><input name="name1" value="${prod01.name}"/></td>
			...
			<tr><td><input name="name2" value="${prod02.name}"/></td>
				<td><input name="price2" value="${prod02.price}"/></td>
				<td><input name="cnt2"  size="1" value="${prod02.cnt}"/></td>
				<td align="center">${prod02.price*prod02.cnt}</td></tr>
